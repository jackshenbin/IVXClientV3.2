...
{
    public class TrafficFluxHistoryViewModel
    {
        public event EventHandler SearchFinished;
        Dictionary<string, bool> m_DicTrafficEvent;
        List<TaskStroreInfoV3_1> m_taskList;
        List<TrafficFluxHistoryInfo> m_trafficInfoListSum;
        bool m_OverTime;
        object m_lockVar;

        public TrafficFluxHistoryViewModel()
        {
            m_DicTrafficEvent    = new Dictionary<string, bool> {};
            m_taskList           = new List<TaskStroreInfoV3_1> {};
            m_trafficInfoListSum = new List<TrafficFluxHistoryInfo> {};
        ...
        public void Search(List<string> cameraIdList, UInt32 BeginTimeSec, UInt32 EndTimeSec)
        {
            //  清空上次查询数据 ...
            ClearModelData();
            // 查询所有相机
