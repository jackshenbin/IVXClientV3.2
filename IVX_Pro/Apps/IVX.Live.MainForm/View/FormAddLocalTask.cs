...
{
    public partial class FormAddLocalTask : IVX.Live.MainForm.UILogics.FormBase
    {
        public FormAddLocalTask()
        {
            InitializeComponent();
  ...
  <AnalyseParam /> 
        ...
        private void FormAddEditTask_Load(object sender, EventArgs e)
        {
            ...
            ucFtpFileSystem1.InitLocalRoot();
        ...
        private void ucFtpFileSystem1_FilesDoubleClicked(object sender, EventArgs e)
        {
            ...
            foreach (var item in selectedfiles)
            {
                ...
                ucTaskAdd1.AddFile(vals[0].ToString(), vals[1].ToString(), Convert.ToUInt64(vals[2]), 1);
            }
        }
