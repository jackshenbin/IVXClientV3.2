...
{
    public partial class FormVehicleSearch : IVX.Live.MainForm.UILogics.FormBase
    {
        ...
        public override void DoAction(object action)
        {
            if (action is DataModel.TaskInfoV3_1)
            {
                ...
                ucVehicleSearchSetting1.SetBegionSearchInfo(bi);
            ...
            {
                ucVehicleSearchSetting1.SetBegionSearchInfo(action as DataModel.BeginSearchInfo);
            }
        }
        ...
        {
            ucSearchResultPanel1.InitPanel(DataModel.SearchType.Vehicle);
        }
    }
}
