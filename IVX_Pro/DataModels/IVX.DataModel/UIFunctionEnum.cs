...
namespace IVX.DataModel
{
    ...
    public class UIFuncItemInfo
    {
        ...
        public static UIFuncItemInfo REALTIMESTASKS = new UIFuncItemInfo(UIFunctionEnum.RealtimeTasks, "计划任务", CONFIGURATION, false);

        public static UIFuncItemInfo ALARMMONITOR = new UIFuncItemInfo(UIFunctionEnum.Alarm, "报警", null, false);
        ...
        public static UIFuncItemInfo SERVERREBOOT = new UIFuncItemInfo(UIFunctionEnum.ServerReboot, "服务器重启", CONFIGURATION); 
        ...
        public static UIFuncItemInfo CROWDALARM = new UIFuncItemInfo(UIFunctionEnum.CrowdAlarm, "报警");
        public static UIFuncItemInfo CROWDPLAY = new UIFuncItemInfo(UIFunctionEnum.CrowdPlay, "预览");
        public static UIFuncItemInfo CROWDQUERY = new UIFuncItemInfo(UIFunctionEnum.CrowdQuery, "查询");
        
        public static UIFuncItemInfo PLATEPLAY = new UIFuncItemInfo(UIFunctionEnum.PlatePlay, "预览");
        public static UIFuncItemInfo PLATEQUERY = new UIFuncItemInfo(UIFunctionEnum.PlateQuery, "查询");

        public static UIFuncItemInfo BEHAVIORALARM = new UIFuncItemInfo(UIFunctionEnum.BehaviorAlarm, "报警");
        public static UIFuncItemInfo BEHAVIORPLAY = new UIFuncItemInfo(UIFunctionEnum.BehaviorPlay, "预览");
        public static UIFuncItemInfo BEHAVIORQUERY = new UIFuncItemInfo(UIFunctionEnum.BehaviorQuery, "查询");

        public static UIFuncItemInfo GISMAP = new UIFuncItemInfo(UIFunctionEnum.GisMap, "FormGisMap");
