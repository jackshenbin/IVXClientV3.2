...
namespace IVX.DataModel
{
    ...
    #region TaskFileTypeInfo

    public class TaskFileTypeInfo
    {
        public TaskFileType Status { get; set; }
        ...
        public TaskFileTypeInfo(TaskFileType status, string name)
        {
            Status = status;
            Name = name;
        }
    ...
    public class TaskTypeInfo
    {
        ...
        public TaskTypeInfo(TaskType status, string name)
        {
            Status = status;
            Name = name;
        }
