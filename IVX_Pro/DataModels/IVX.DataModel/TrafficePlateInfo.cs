...
namespace IVX.DataModel
{
    ...
    /// </summary>
    [Serializable]
    public class TrafficePlateInfo : IDisposable
    {
    ...
    public class TrafficePlateProperty : PropertyBase, IDisposable
    {
        private TrafficePlateInfo _Control;
        public TrafficePlateProperty()
        {

        }
        public TrafficePlateProperty(TrafficePlateInfo control)
        {
        ...
        public TrafficePlateInfo GetBase()
        {
            return _Control;
        }
