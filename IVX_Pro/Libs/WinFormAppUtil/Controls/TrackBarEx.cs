...
namespace WinFormAppUtil.Controls
{
    ...
    {
        private long _Max = 100;//进度条的最大值

        private long _Mth = 1;//进度条现在的值
        ...
        private void InitializeComponent()
        {
            ...
            this.BackgroundImage = global::WinFormAppUtil.Properties.Resources.进度背景;
        ...
        public void SetBlood()
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action(SetBlood));
            }
            else
            {
                if (!Enabled)
